  ...
  return (
    <div style={{backgroundImage: 'url("https://images.pexels.com/photos/326278/pexels-photo-326278.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")', height: '100vh', backgroundSize: 'cover' }}>
      <div className="container d-flex justify-content-center align-items-center" style={{ height: '100%' }}>
        <form onSubmit={handleSubmit} className='w-50  m-auto mt-6 pt-4 p-4  pb-5 border bg-dark border-warning rounded'>
          <h2 className="text-light mb-4">Add Food Item</h2>
          <div className="mb-3">
          ...
          <button type="submit" className="btn btn-warning text-white">Add Food Item</button>
        </form>
      </div>
    </div>
  );
